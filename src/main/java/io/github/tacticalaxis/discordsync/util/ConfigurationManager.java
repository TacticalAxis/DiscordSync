...
import io.github.tacticalaxis.discordsync.DiscordSync;
...
public class ConfigurationManager {
    ...
    public void setupConfiguration() {
        configTest();
        mainFile = new File(DiscordSync.getInstance().getDataFolder(), mainConfigName);
    ...
    public void reloadConfiguration() {
        for (String ymlFile : this.ymlFiles) {
            try {
                this.configs.get(ymlFile).load(new File(DiscordSync.getInstance().getDataFolder(), ymlFile));
